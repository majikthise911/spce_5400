...
<h1 style="font-size: 52pt; font-weight: bold; margin: 0; color: #00205B; font-family: Georgia, serif;">RAD-AI</h1>
<p style="font-size: 13pt; margin: 15px 0 0 0; color: #333; font-family: Georgia, serif;">Radiation-Mitigated Edge AI for Autonomous Space Operations</p>
</div>

<!-- Satellite Image - Full Width, overlaps into sections -->
<div style="flex-grow: 1; display: flex; align-items: center; justify-content: center; margin-top: -20px;">
<img src="../images/figure_a2_deployed.png" alt="RAD-AI 6U CubeSat - Deployed Configuration" style="max-width: 100%; max-height: 550px;">
</div>

<!-- Footer Info -->
<div style="text-align: center; padding: 35px 40px; color: #00205B;">
<p style="font-size: 13pt; font-weight: bold; margin: 0 0 8px 0;">SPCE 5400 – Small Satellite Engineering & Operations</p>
<p style="font-size: 12pt; margin: 4px 0; font-weight: normal;">Jordan Clayton</p>
<p style="font-size: 12pt; margin: 4px 0; font-weight: normal;">December 2025</p>
</div>
